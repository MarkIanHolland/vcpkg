function(vcpkg_configure_meson)
    ...
    elseif(CMAKE_HOST_SYSTEM_NAME STREQUAL "Linux")
        set(MESON_COMMON_CFLAGS "${MESON_COMMON_CFLAGS} -Wall")
        set(MESON_COMMON_CXXFLAGS "${MESON_COMMON_CXXFLAGS} -Wall")
    
        if(DEFINED VCPKG_CRT_LINKAGE AND VCPKG_CRT_LINKAGE STREQUAL dynamic)
            set(MESON_DEBUG_CFLAGS "${MESON_DEBUG_CFLAGS}")
            set(MESON_DEBUG_CXXFLAGS "${MESON_DEBUG_CXXFLAGS}")
            
            set(MESON_RELEASE_CFLAGS "${MESON_RELEASE_CFLAGS} -O2 -Og")
            set(MESON_RELEASE_CXXFLAGS "${MESON_RELEASE_CXXFLAGS} -O2 -Og")
        elseif(DEFINED VCPKG_CRT_LINKAGE AND VCPKG_CRT_LINKAGE STREQUAL static)
            set(MESON_DEBUG_CFLAGS "${MESON_DEBUG_CFLAGS}")
            set(MESON_DEBUG_CXXFLAGS "${MESON_DEBUG_CXXFLAGS}")
        ...
        set(MESON_COMMON_LDFLAGS "${MESON_COMMON_LDFLAGS}")
        set(MESON_RELEASE_LDFLAGS "${MESON_RELEASE_LDFLAGS}")
    endif()
